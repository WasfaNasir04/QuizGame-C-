...
int main()
{
	...
	case'S':	
    	...
    	else
    	{
    		cout<<"\nSorry,... your answer is wrong"<<" "
    		    <<"\nCorrect answer is Hazrat Abu Bakar(R.A)"<<endl;
	        score=score+(-50);
	    }
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
		    <<"\nCorrect answer is Hazrat Bilal(R.A)"<<endl;
	    score=score+(-50);
		}
		cout<<"Press any Key to Move to Next question"<<endl;
		getch();
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
	        <<"\nCorrect answer is In the cave of Hira"<<endl;
	    score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is On 9 and 10 Zil Hajj"<<endl;
     	score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	    ...
	    score=score+100;
     	...
     	{
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is In 1992"<<endl;
    	score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is Imran Khan"<<endl;
    		score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is Wickets"<<endl;
	    	score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	...
	else if(option[0]==3)
	{
	    ...
	    { 
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is roots are unequal and imaginary"<<endl;
        score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
    	...
    	{
			cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is (x+y)(x-y)"<<endl;
    		score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	...
	else if(option[0]==4)
	{
	    ...
	    {
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is humko hmin sy chura lo"<<endl;
	    	score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
    	...
    	{
		cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is Ye ishq hai"<<endl;
	    	score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
	    ...
	    {
			cout<<"\nSorry,...your answer is wrong"<<" "
	    <<"\nCorrect answer is 3 Idots"<<endl;
    		score=score+(-50);
		}
		cout<<"Press any Key to move to next question"<<endl;
		getch();
